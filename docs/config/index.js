...
module.exports = {
  ...
  aliases: {
    ...
    'vue-formly-quasar': path.resolve(__dirname, '../../node_modules/@decision6/vue-formly-quasar'),
    'vue-formly': path.resolve(__dirname, '../../node_modules/vue-formly'),
    // 'q-formly': path.resolve(__dirname, '../../src') // only dev
    'q-formly': path.resolve(__dirname, '../../dist/q-formly')
  },
